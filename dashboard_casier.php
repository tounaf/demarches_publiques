...
<div class="topnav" id="myTopnav">
  ...
  <a href="dashboard_casier.php" class="active">Gestion - Extrait casier judiciaire</a>
  ...
  <div class="container-fluid">
    ...
    <div class="row pt-5">
      <div class="col-md-12 col-lg-12">
        <section id="">
          <div class="container">
            <h2 class="pb-3">Gestion des casiers judiciaires</h2>
            <table id="table_id" class="display table-striped table table-bordered dt-responsive">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT * FROM casierjudiciaire ORDER BY id_casier ASC";
                  ...
                  ?>
                  <tr data-id="<?php echo $row['id_casier']; ?>">
                    ...
                    <td>
                      <center>
                        <a href="traitement/casierJudiciaire_facture.php?id=<?php echo $row['id_casier']; ?>">
