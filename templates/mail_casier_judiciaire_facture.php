...
if (isset($id)) {
  $sqlVoir = "SELECT * FROM casierjudiciaire WHERE id_judiciaire = $id";
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="text-center">
                <h2>Facture N° # <input style="text-align: center; width: 130px;" disabled class="" name="id_naissance" value="<?= isset($data["id_naissance"])? $data["id_naissance"]: '' ?>"></h2>
            </div>
            <hr>
            <div class="row">
                ...
                <div class="col-xs-12 col-md-3 col-lg-3 pull-right">
                    <div class="panel panel-default height">
                        ...
                        <div class="panel-body">
                            ...
                            <span><?= isset($data["prenom"])? $data["prenom"]: '' ?></span><br>
