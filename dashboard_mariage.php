            ...
            <table id="table_id" class="display table-striped table table-bordered dt-responsive">
                ...
                <tbody>
                  ...
                  <tr data-id="<?php echo $row['id_mariage']; ?>">
                    ...
                    <td>
                      <center>
                        <a href="traitement/acteDeMariage_facture.php?id=<?php echo $row['id_mariage']; ?>">
                          <button class="btn btn-primary"><i class="fa fa-money"></i></button>
                        </a>
                      	<a href="traitement/acteDeMariage_voir.php?id=<?php echo $row['id_mariage']; ?>">
                          <button class="btn btn-info"><i class="fa fa-eye"></i></button>
                        </a>
                        <a href="traitement/acteDeMariage_delete.php?id=<?php echo $row["id_mariage"] ?>" class="btn btn-danger" onclick="return confirm('Please confirm!')">
