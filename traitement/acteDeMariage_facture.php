    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="text-center">
                <h2>Facture N° # <input style="text-align: center; width: 130px;" disabled class="" name="id_mariage" value="<?= isset($data["id_mariage"])? $data["id_mariage"]: '' ?>"></h2>
            </div>
            <hr>
            <div class="row">
                ...
                <div class="col-xs-12 col-md-3 col-lg-3 pull-right">
                    <div class="panel panel-default height">
                        ...
                        <div class="panel-body">
                            ...
                            <span><?= isset($data["nom_naissance"])? $data["nom_naissance"]: '' ?></span><br>
                            <span><?= isset($data["prenom_naissance"])? $data["prenom_naissance"]: '' ?></span><br>
                            <span><?= isset($data["email_acte"])? $data["email_acte"]: '' ?></span><br>
                            <span><?= isset($data["telephone"])? $data["telephone"]: '' ?></span><br>
                        </div>
                    </div>
                </div>
            </div>
